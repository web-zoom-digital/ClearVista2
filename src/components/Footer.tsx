...
export default function Footer() {
  ...
  return (
    <footer style={{ background: '#060606', borderTop: '1px solid rgba(200,169,110,0.1)' }}>
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '60px 52px 32px' }}>
        {/* Top grid */}
        <div style={{ display: 'grid', gridTemplateColumns: '2.5fr 1fr 1fr 1fr', gap: '48px', marginBottom: '52px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '12.5px', color: 'rgba(255,255,255,0.38)', lineHeight: 1.75, maxWidth: '260px', marginTop: '16px' }}>
          ...
          {Object.entries(cols).map(([title, links]) => (
            <div key={title}>
              <h4 style={{ fontSize: '9px', fontWeight: 700, letterSpacing: '0.22em', color: GOLD, textTransform: 'uppercase', marginBottom: '18px' }}>
                {title}
              </h4>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '22px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.22)', letterSpacing: '0.02em' }}>
            &copy; 2026 ClearVista. All rights reserved. Premium uPVC Windows &amp; Doors | Made in India.
          </p>
