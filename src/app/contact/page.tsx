...
export default function ContactPage() {
  ...
  return (
    <main style={{ background: '#0a0a0a', minHeight: '100vh', paddingTop: '64px' }}>
      {/* Header */}
      <section style={{ background: '#141414', padding: '60px 0', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="section-inner">
          ...
          <h1 style={{ fontFamily: 'Outfit', fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 900, letterSpacing: '-0.02em', textTransform: 'uppercase', color: 'white', marginBottom: '16px' }}>
            Request a Quote
          </h1>
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.45)', maxWidth: '520px', lineHeight: 1.8 }}>
      ...
      <section style={{ padding: '64px 0' }}>
        <div className="section-inner">
          {/* Contact info + form: 2col → 1col on mobile */}
          <div className="two-col" style={{ alignItems: 'flex-start' }}>
            {/* Contact Info */}
            <div>
              <h2 style={{ fontSize: '16px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em', color: 'white', marginBottom: '32px' }}>Contact Info</h2>
              {[
                ...
                <div key={item.label} style={{ marginBottom: '24px', paddingBottom: '24px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            {submitted ? (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '360px', textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '22px', fontWeight: 800, color: '#c8a96e', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '12px' }}>Thank You!</h2>
